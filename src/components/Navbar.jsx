...
const Navbar = () => {
  ...
  const linkClasses ="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-teal-400 transition duration-300";
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md hover:text-teal-400 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-400"
