...
export default function Navbar() {
  ...
  const linkClass = (p) => {
    ...
    const base = 'font-medium rounded-lg transition duration-200 text-sm lg:text-base';
    if (active) return `${base} px-4 py-2 text-white bg-teal-600 shadow-md`;
    return isDarkMode
      ? `${base} px-1 lg:px-4 py-1.5 lg:py-2 text-gray-300 hover:text-teal-400 hover:bg-gray-800`
      : `${base} px-1 lg:px-4 py-1.5 lg:py-2 text-gray-700 hover:text-teal-600 hover:bg-teal-50`;
  };
