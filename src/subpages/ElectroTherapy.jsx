...
const ElectroTherapyData = {
    keyTherapies: [
        {
            ...
            description:
                'TENS uses <strong>low-frequency electrical currents</strong> applied through surface electrodes to relieve pain. It works mainly on the <strong>Gate Control Theory</strong> of pain and is widely used in acute and chronic pain conditions.',
            benefits: [
        ...
        },
        {
            ...
            description:
                'IFT uses <strong>medium-frequency currents</strong> that intersect within tissues to produce deep analgesic effects. It is effective for <strong>muscle pain, joint pain, and inflammation</strong>.',
            benefits: [
        ...
        },
        {
            ...
            description:
                'Ultrasound therapy uses <strong>high-frequency sound waves</strong> to promote tissue healing, reduce pain, and improve soft tissue extensibility. It is commonly used in <strong>tendon and ligament injuries</strong>.',
            benefits: [
        ...
        },
        {
            ...
            description:
                'SWD uses <strong>high-frequency electromagnetic waves</strong> to produce deep heating in tissues. It helps in pain relief, muscle relaxation, and improving circulation.',
            benefits: [
                'Deep heating effect',
        ...
        },
        {
            ...
            description:
                'Infrared radiation produces <strong>superficial heating</strong> of tissues. It is mainly used to relieve pain, improve circulation, and reduce muscle stiffness.',
            benefits: [
    ...
    advancedApplications: [
    {
        ...
        description:
            'NMES uses <strong>electrical stimulation to produce muscle contraction</strong>. It is used for muscle strengthening, re-education, and prevention of muscle atrophy.',
        benefits: [
    ...
    },
    {
        ...
        description:
            'CPM is a mechanical modality that moves a joint <strong>passively through a controlled range</strong>. It is commonly used after orthopedic surgeries.',
        benefits: [
    ...
    },
    {
        ...
        description:
            'Cervical traction applies a <strong>gentle pulling force to the neck</strong> to reduce nerve root compression and relieve cervical pain.',
        benefits: [
            'Relieves neck pain',
    ...
    },
    {
        ...
        description:
            'Russian current is a form of <strong>medium-frequency electrical stimulation</strong> mainly used for muscle strengthening.',
        benefits: [
    ...
    },
    {
        ...
        description:
            'Lumbar traction applies <strong>traction force to the lower spine</strong> to reduce disc pressure and relieve low back pain.',
        benefits: [
...
const ElectroTherapy = () => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {ElectroTherapyData.advancedApplications.map((app) => (
            <div
                key={app.id}
                className={`flex flex-col h-full rounded-xl overflow-hidden shadow-md transition-transform  ${
