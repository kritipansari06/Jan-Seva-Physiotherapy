...
const EquipmentData = {
    keyEquipment: [
        { id: 'electrotherapy', title: 'Electrotherapy Devices', icon: '⚡', description: 'Includes <strong>TENS, IFT, Ultrasound therapy units, NMES, and Laser machines</strong>. Use electrical currents, sound waves, or light to reduce pain, activate weak muscles, and promote tissue healing.' },
        { id: 'exercise', title: 'Exercise & Strengthening Equipment', icon: '💪', description: 'Features <strong>resistance bands, dumbbells, medicine balls, ankle weights, physioballs, and pulley systems</strong>. Rebuild strength, flexibility, endurance, and joint stability during rehabilitation.' },
        { id: 'mobility', title: 'Mobility Support Equipment', icon: '🚶', description: 'Includes <strong>walkers, canes, crutches, wheelchairs, orthotic supports, and braces</strong>. Help patients move safely by stabilizing weak joints, reducing strain, and improving balance.' },
        { id: 'manual', title: 'Manual Therapy Tools', icon: '🖐️', description: 'Contains <strong>foam rollers, massage guns, trigger-point tools, cupping sets, and IASTM instruments</strong>. Reduce muscle tension, break adhesions, improve circulation, and support soft-tissue release.' },
        { id: 'cardio', title: 'Cardio-Rehab Machines', icon: '🏃', description: 'Includes <strong>treadmills, stationary cycles, steppers, and cross-trainers</strong>. Build stamina, cardiovascular fitness, and functional endurance during long-term rehabilitation programs.' },
        { id: 'specialized', title: 'Specialized Treatment Equipment', icon: '🔧', description: 'Advanced tools including <strong>traction units, shockwave therapy devices, and compression therapy systems</strong>. Provide targeted treatment for complex conditions and accelerate recovery.' }
    ],
    secondaryEquipment: [
    ...
    advancedEquipment: [
        { id: 'electrotherapy-clinical', title: 'Electrotherapy Devices', icon: '🔬', description: 'Therapeutic systems such as <strong>muscle stimulators, ultrasound units, laser therapy devices, and diathermy machines</strong> used to control pain, increase blood flow, and assist injured muscles in regaining function.' },
        { id: 'exercise-functional', title: 'Exercise & Strengthening Equipment', icon: '🎯', description: 'Functional tools like <strong>resistance machines, wall pulleys, balance cushions, wobble boards, and core-training tools</strong> that enhance stability, correct imbalances, and support safe return to physical activity.' },
        { id: 'mobility-daily', title: 'Mobility Support Equipment', icon: '🦽', description: 'Daily-use supports including <strong>walking sticks, tripod canes, wheelchairs, knee braces, ankle supports, and orthotic inserts</strong> that help maintain mobility and protect joints during the healing phase.' },
        { id: 'manual-recovery', title: 'Manual Therapy Tools', icon: '🌡️', description: 'Recovery aids such as <strong>hot/cold packs, massage sticks, handheld rollers, and IASTM blades</strong> that complement manual techniques by easing muscle tension and improving tissue quality.' },
        { id: 'cardio-lowimpact', title: 'Cardio-Rehab Machines', icon: '🚴', description: 'Low-impact devices like <strong>recumbent bikes, air bikes, and compact step machines</strong> that maximize cardiovascular training while reducing stress on joints, ideal for rehabilitation and wellness.' },
        { id: 'assessment-tools', title: 'Assessment & Monitoring Tools', icon: '📊', description: 'Clinical measurement devices including <strong>goniometers, dynamometers, posture analyzers, and range-of-motion tools</strong> that help track progress, measure improvements, and ensure optimal treatment outcomes.' }
    ]
};
